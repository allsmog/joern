...
Reconciled against commit `025d9778c` on 2026-08-18. Execute current plans in
priority/dependency order. Each executor must read its plan completely, run its
